...
if(!a&&1*i.dataset.ready===0)return!o&&k.show("生成订单中"),setTimeout(v,100,{
currentTarget:i
},!0);
...
var C=window.user_uin||0,R=Math.floor(C/100)%1e3,q=0!==C&&1001>R,N=!0,M="",D=5,L=_.isIOS&&_.gtVersion("7.0.10",!0)||_.isAndroid&&_.gtVersion("7.0.12",!0),K=L&&""===window.nickname&&""===window.nickname_new?"未命名公众号":window.title;
