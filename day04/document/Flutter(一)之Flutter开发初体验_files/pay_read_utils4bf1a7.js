...
qt&&0===Wt?(document.getElementById("js_cmt_nofans1").innerHTML="作者已设置关注3天后才可留言",
m(document.getElementById("js_cmt_nofans1"),"block")):Bt&&0===i.is_fans?(document.getElementById("js_cmt_nofans1").innerHTML="作者已设置关注后才可以留言",
...
}else d(Dt.main),qt&&0===Wt?(document.getElementById("js_cmt_nofans2_inner").innerHTML="作者已设置关注3天后才可留言",
m(document.getElementById("js_cmt_nofans2"),"block")):Bt&&0===i.is_fans?(document.getElementById("js_cmt_nofans2_inner").innerHTML="作者已设置关注后才可以留言",
...
en&&console.info("[图文评论] 开始请求评论数据:",s),st("[Appmsg comment] start get comment data, url:"+s),
it({
url:s,
dataType:"json",
success:function(e){
...
Xt||(Zt&&(Zt.style.display="none"),$t&&($t.style.display="none"),Et=0),en&&console.info("[图文评论] 评论ID:",Et),
W(),{
initComment:q,
getCommentData:j,
renderComment:h
