...
}else document.title=window.title;else 40>e&&H&&(H=!1,L?y.invoke("currentMpInfoHide",function(){}):document.title="");
}
function W(e,t){
var o={
...
var X,Z=null;
T(),h.on(window,"scroll",T),R(),h.on(window,"scroll",C),y.on("topbar:click",function(){
var e={
BizUin:biz,
AppMsgID:1*mid,
ItemIndex:1*idx,
...
}),"1"===window.localStorage.getItem(e)&&k.report110809(30)),a)for(var d=document.getElementsByClassName("js_pay_qrcode"),p="/mp/paysubqrcode?action=get_article_qrcode&__biz="+window.biz+"&mid="+window.mid+"&idx="+window.idx+"&sn="+window.sn+"#wechat_redirect",m=0,w=d.length;w>m;m++)d[m].src=p;
...
var jt=Math.random();
if(2e-4>jt)try{
for(var xt=document.getElementsByTagName("img"),St=window.screen.height,kt=window.screen.width,Et=0,Pt=window.devicePixelRatio,Et="",G=0,zt=xt.length;zt>G;G++){
var Bt=xt[G].getAttribute("data-src");
if(Bt){
var Ot=xt[G].getBoundingClientRect();
Et+=kt+"|"+St+"|"+Ot.left.toFixed(2)+"|"+(kt-Ot.right).toFixed(2)+"|"+Ot.width.toFixed(2)+"|"+Pt.toFixed(2)+"|"+Bt+";";
}
}
l({
...
e("appmsg/popup_report.js")),k=e("appmsg/pay_report_utils.js"),E=e("appmsg/loading.js"),P=-1,z=e("appmsg/finance_communicate.js"),B=e("biz_common/utils/monitor.js"),O=e("common/comm_report.js"),T=e("appmsg/getForbidConfig.js");
window.new_appmsg&&(e("page/appmsg_new/combo.css"),e("page/appmsg_new/not_in_mm.css")),
e("appmsg/finance_communicate.js");
var R=window.user_uin||0,C=Math.floor(R/100)%1e3,q=0!==R&&1001>C,N=!0,M="",D=5,L=_.isIOS&&_.gtVersion("7.0.10",!0)||_.isAndroid&&_.gtVersion("7.0.12",!0),K=L&&""===window.nickname&&""===window.nickname_new?"未命名公众号":window.title;
