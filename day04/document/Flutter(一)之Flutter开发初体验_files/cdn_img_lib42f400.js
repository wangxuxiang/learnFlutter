...
video_iframe:[],
video_top:[]
},l=e("pages/version4video.js"),_=e("biz_common/dom/attr.js"),u=(_.setProperty,e("biz_common/dom/event.js")),w=document.getElementsByTagName("iframe"),f=[];
...
s=s.replace(/&amp;/g,"&");
for(var m=s.split("&"),_=["/mp/newappmsgvote?action=show"],u=0;u<m.length;u++)(0==m[u].indexOf("__biz=")||0==m[u].indexOf("supervoteid="))&&_.push(m[u]);
_.length>1&&(i=_.join("&")+"#wechat_redirect");
}
}
if(r&&(p.txVideoReg.test(r)||p.mpVideoReg.test(r))){
if(l.isShowMpVideo()||p.mpVideoReg.test(r)){
