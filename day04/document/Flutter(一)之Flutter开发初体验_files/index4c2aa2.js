...
function R(e){
try{
for(var c=window.pageYOffset||document.documentElement.scrollTop,m=0;m<Q.length;m+=M){
var u=Q[m];
if(!(u.offsetTop>c+x.getInnerHeight()+100)){
var g=w.attr(u,"data-cpsstatus");
if("hide"==g){
u.setAttribute("data-cpsstatus","loading");
for(var f=""+m,y=1,v=m+1;v<Q.length&&m+M>v;v++)f=f+"%2c"+v,y++;
...
O.report(17335,t),H=!0;
}
}else document.title=window.title;else 40>e&&W&&(W=!1,D?y.invoke("currentMpInfoHide",function(){}):document.title="");
}
function U(e,t){
var o={
...
"list"==J?Q[G].innerHTML=n.tmpl(d,Y):"banner"==J?Q[G].innerHTML=n.tmpl(r,Y):"card"==J&&(Q[G].innerHTML=n.tmpl(a,Y));
}
}catch($){
console.log($);
}
var X,Z=null;
T(),h.on(window,"scroll",T),R(),h.on(window,"scroll",K),y.on("topbar:click",function(){
var e={
BizUin:biz,
AppMsgID:1*mid,
ItemIndex:1*idx,
...
(o.top<=0&&o.top+o.height>=0||o.top>0&&o.top<s)&&(a.splice(e,1),e--,S.report([1,S.getRedirectType(t.parentNode.getAttribute("href")),"",img_popup?1:0,window.source,S.getUrlData(t.parentNode.getAttribute("href"))]));
}
for(var e=0;e<d.length;e++){
var t=d[e],o=t.getBoundingClientRect();
(o.top<=0&&o.top+o.height>=0||o.top>0&&o.top<s)&&(d.splice(e,1),e--,S.report([1,1,"",img_popup?1:0,window.source,t.getAttribute("data-miniprogram-appid")]));
}
}
function o(){
e(),t();
...
}),"1"===window.localStorage.getItem(e)&&k.report110809(30)),a)for(var s=document.getElementsByClassName("js_pay_qrcode"),p="/mp/paysubqrcode?action=get_article_qrcode&__biz="+window.biz+"&mid="+window.mid+"&idx="+window.idx+"&sn="+window.sn+"#wechat_redirect",m=0,w=s.length;w>m;m++)s[m].src=p;
...
if(k.report110809(38),window.payProductId!==o.productId)return void k.report110809(44);
window.oriProductFee?("CNY"!==o.currencyCode&&k.report110809(40),k.reportOverseaPay(o.currencyCode,100*o.price.toFixed(2),1,i,o.countryCode,0,o.err_msg+(o.err_desc?"__"+o.err_desc:""))):(window.IAPProductInfo=o,
window.IAPProductInfo.invokeTime=i);
}else k.report110809(39),k.reportOverseaPay("",0,1,0,"",1,o.err_msg+(o.err_desc?"__"+o.err_desc:""));
}
});
...
if(!a&&1*i.dataset.ready===0)return!o&&E.show("生成订单中"),setTimeout(v,100,{
currentTarget:i
},!0);
if(k.reportPayAppmsg(9),window.is_temp_url)window.weui.alert("临时链接无需付费，请谨慎分享，避免内容泄露",function(){
...
_.isAndroid&&"1"===window.localStorage.getItem(e)&&k.report110809(31),k.report110809ForDevice(34);
var t=function(){
...
g=!1,k.report110809(t.err_msg.indexOf("ok")>-1?19:20),window.localStorage&&window.localStorage.setItem&&window.localStorage.setItem(e,"1"),
...
k.reportPay(o,1,e.order_id),t()):i.err_msg.indexOf("cancel")>-1?(g=!1,k.report110809(28),
k.reportPay(o,2,e.order_id),console.log("pay cancel")):i.err_msg.indexOf("fail")>-1?(g=!1,
k.report110809(16),k.reportPay(o,3,e.order_id,i.err_msg,i.err_code,i.err_domain),
...
window.IAPProductInfo?window.IAPProductInfo.currencySymbol!==o.currencySymbol&&k.report110809(43):window.oriProductFee&&"￥"!==o.currencySymbol&&k.report110809(43),
...
console.log("directPay res: ",i,n),1===i?(k.report110809(17),k.reportPay(o,1,e.order_id,n,i),
t()):-1===i&&/:cancel$/.test(n)?(g=!1,k.report110809(29),k.reportPay(o,2,e.order_id,n,i),
console.log("pay cancel")):(g=!1,k.report110809(18),k.reportPay(o,3,e.order_id,n,i),
...
e("appmsg/share.js");
var dt=v(1e3*parseInt(window.modify_time)),st=dt.format("YYYY-MM-DD"),pt=document.getElementById("js_modify_time");
if(pt&&(pt.innerHTML=st),window.isSg||"mp.weixin.qq.com"==location.host){
...
(q||navigator.userAgent.indexOf("Br_trunk")>-1)&&_.isIOS&&(d||s)&&!p?(console.info("[HEVC代理] 当前版本可以启用HEVC代理"),
...
is_https_res||C?a=a.http2https():("http:"==location.protocol||-1!=navigator.userAgent.indexOf("MicroMessenger"))&&(a=a.https2http())),
setTimeout(function(){
r.onload=function(){
...
for(var i=0;i<t.length;i++)"a"!=t[i].tagName.toLowerCase()&&E(t[i]);
}catch(n){}
};
try{
...
var c=1e3,l=window.user_uin||0,w=0!==l&&Math.floor(l/100)%1e3<c,u=(i>=43305&&44206!=i||d>=16)&&o.isGif(),g=0!==l&&Math.floor(l/100)%1e3<=500,f=d>=564&&o.canHevc()&&_.gtVersion("6.8.0",!0)&&g;
w&&(u||f)?(o=rt.addParam(o,"tp","wxpic",!0),window.__addIdKeyReport("28307",91)):window.webp&&(o=rt.addParam(o,"tp","webp",!0),
window.__addIdKeyReport("28307",84)),o=rt.addParam(o,"wxfrom","5",!0),is_https_res||C?(o=o.http2https(),
...
return N&&(v||b)&&(window.__addIdKeyReport("28307",106),o=rt.addParam(o,"tp","wxpic",!0),
o=N+"hevc?url="+encodeURIComponent(o)+"&type="+o.getOriginImgType()),"anonymous"==e.crossOrigin&&(o=rt.addParam(o,"wx_co","1",!0)),
...
1>=r&&window.__addIdKeyReport("28307",87+1*r)),N&&e.indexOf(N)>-1&&window.__addIdKeyReport("28307",107),
...
return c.hasClass(_t,"rich_media_meta_link")?window.is_temp_url?(window.weui.alert("预览状态下不能操作"),
...
n.offsetTop<d&&(r=!0,B.setSum(59977,15,1));
}
});
}
}(),m("[Appmsg] href:"+location.href+"^^^ ua:"+window.navigator.userAgent),window.addEventListener?window.addEventListener("load",F,!1):window.attachEvent&&window.attachEvent("onload",F),
...
var jt=Math.random();
if(2e-4>jt)try{
for(var xt=document.getElementsByTagName("img"),St=window.screen.height,kt=window.screen.width,Et=0,zt=window.devicePixelRatio,Et="",G=0,Pt=xt.length;Pt>G;G++){
var Bt=xt[G].getAttribute("data-src");
if(Bt){
var Ot=xt[G].getBoundingClientRect();
Et+=kt+"|"+St+"|"+Ot.left.toFixed(2)+"|"+(kt-Ot.right).toFixed(2)+"|"+Ot.width.toFixed(2)+"|"+zt.toFixed(2)+"|"+Bt+";";
}
}
l({
...
setTimeout(function(){
P&&P.postPageHeightMessage&&P.postPageHeightMessage("updatePageHeight");
...
e("appmsg/popup_report.js")),k=e("appmsg/pay_report_utils.js"),E=e("appmsg/loading.js"),z=-1,P=e("appmsg/finance_communicate.js"),B=e("biz_common/utils/monitor.js"),O=e("common/comm_report.js");
window.new_appmsg&&(e("page/appmsg_new/combo.css"),e("page/appmsg_new/not_in_mm.css")),
e("appmsg/finance_communicate.js");
var T=window.user_uin||0,R=Math.floor(T/100)%1e3,C=0!==T&&1001>R,q=!0,N="",M=5,D=_.isIOS&&_.gtVersion("7.0.10",!0)||_.isAndroid&&_.gtVersion("7.0.12",!0),L=D&&""===window.nickname&&""===window.nickname_new?"未命名公众号":window.title;
...
var V=window.location.protocol;
j.saveSpeeds({
uin:uin,
pid:"https:"==V?462:417,
speeds:{
