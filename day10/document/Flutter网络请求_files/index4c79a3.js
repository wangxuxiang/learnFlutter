...
var Q,G=null;
O(),h.on(window,"scroll",O),R(),h.on(window,"scroll",T),window.is_new_msg&&-1!=navigator.userAgent.indexOf("MicroMessenger")&&(window.title&&(window.title=window.title.replace(/&#39;/g,"'").replace(/&nbsp;/g," ").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&amp;/g,"&")),
...
C.setSum(28307,18,1),u.isIOS&&C.setSum(28307,19,1),u.isAndroid&&C.setSum(28307,20,1);
},!1);
}(),function(){
...
e("appmsg/popup_report.js")),E=e("appmsg/pay_report_utils.js"),P=e("appmsg/loading.js"),z=-1,S=e("appmsg/finance_communicate.js"),B=e("appmsg/topbar.js"),C=e("biz_wap/utils/jsmonitor_report.js"),O=e("appmsg/getForbidConfig.js");
window.new_appmsg&&(e("page/appmsg_new/combo.css"),e("page/appmsg_new/not_in_mm.css")),
e("appmsg/finance_communicate.js");
var R=window.user_uin||0,T=Math.floor(R/100)%1e3,q=0!==R&&1001>T,N=!0,D="",M=5;
