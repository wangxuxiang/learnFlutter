...
c&&1==!!c.length&&l&&(c=c[0].innerHTML,O.content_length=l.htmlSize),window.logs.pageinfo=O,
function(){
...
function i(e,t){
if(e&&!(e.length<=0))for(var i,o,n,a=/http(s)?\:\/\/([^\/\?]*)(\?|\/)?/,s=0,r=e.length;r>s;++s)i=e[s],
...
function a(){
{
var e,t=window.pageYOffset||document.documentElement.scrollTop,i=T.js_content,o=v.getInnerHeight(),a=T.screen_width,s=T.scroll_height,r=Math.ceil(s/o),d=Math.ceil((i.scrollHeight||i.offsetHeight)/o),_=(window.logs.read_height||t)+o,m=T.pageEndTop,w=T.imgs,p=Math.ceil(_/o)||1,l=T.media,g=50,h=0,f=0,b=0,y=0,j=_+g>m?1:0;
...
function s(e){
D||(D=!0,S.remove(M),e.report_time=parseInt(+new Date/1e3),p({
...
function _(e){
e&&e.play_type&&(I.remove("spad"),e.report_type=1,p({
...
e("biz_common/utils/string/html.js");
var w=e("biz_common/dom/event.js"),p=e("biz_wap/utils/ajax.js"),l=(e("biz_common/utils/cookie.js"),
...
-1!=navigator.userAgent.indexOf("TBS/"),e("biz_wap/utils/jsmonitor_report.js")),T={
js_cmt_area:null,
js_content:null,
screen_height:v.getInnerHeight(),
...
var r=e.container;
if(!r)return!1;
for(var d=r.getElementsByTagName("a")||[],w=0,j=d.length;j>w;++w)!function(r){
var w=d[r],j=w.getAttribute("href");
if(!j)return!1;
var v=0,b=w.innerHTML;
/^[^<>]+$/.test(b)?v=1:/^<img[^>]*>$/.test(b)&&(v=2);
var h=w.getAttribute("data-linktype"),k=w.getAttribute("href");
s.on(w,"tap",function(r){
var s=w.getAttribute("href");
if(!s)return!1;
!!e.changeHref&&!/^https?:\/\/mp\.weixin\.qq\.com\/cgi-bin\//.test(s)&&(s=e.changeHref(s,v)),
r.preventDefault();
var d="";
_[w.getAttribute("data-itemshowtype")]&&(d=_[w.getAttribute("data-itemshowtype")]);
document.getElementById("js_link_dialog_name");
return c[k]&&c[k].subject_name&&"0"===c[k].item_show_type&&c[k].title?o(f,{
title:'即将打开公众号 "'+c[k].subject_name+'" 的'+_[c[k].item_show_type],
desc:y.innerText="《"+c[k].title+"》"
}):c[k]&&c[k].subject_name&&c[k].item_show_type>=0?o(f,{
desc:'即将打开公众号 "'+c[k].subject_name+'" 的'+_[c[k].item_show_type]
}):o(f,{
desc:"即将打开新的页面"
}),r.stopPropagation(),"undefined"==typeof g[k]&&(k.indexOf("mp.weixin.qq.com/s/")>-1||k.indexOf("mp.weixin.qq.com/s?")>-1)?m.setSum(110809,6,1):"undefined"==typeof g[k]&&m.setSum(110809,7,1),
g=function(){
return c[k]&&c[k].item_show_type>=0&&s.indexOf("mp.weixin.qq.com")>-1&&(p.isIOS||p.isAndroid)&&!p.isInMiniProgram&&p.isWechat?1==w.getAttribute("clicked")?!1:(u.invoke("openWebViewUseFastLoad",{
url:s,
item_show_type:c[k].item_show_type,
openType:0,
scene:1
},function(e){
...
}):(w.setAttribute("clicked",0),m.setSum(28839,37,1));
}),!1):void(p.isInMiniProgram?location.href=s:p.isAndroid||p.isIOS?a(s,{
sample:1,
reject:function(){
location.href=s;
}
}):location.href=s);
},("1"===h||i(w)||n(w))&&l.report([2,l.getRedirectType(k),"",img_popup?1:0,window.source,l.getUrlData(k)]),
("1"===h||i(w)||n(w))&&img_popup?(console.log("tap img link"),f.style.display="block",
f._url=k,(i(w)||n(w))&&(m.setSum(110809,8,1),f._type="OTHER"),document.querySelector("body").addEventListener("touchmove",t,{
passive:!1
})):g(),!1;
...
var s=e("biz_common/dom/event.js"),a=e("appmsg/open_url_with_webview.js"),u=e("biz_wap/jsapi/core.js"),p=e("biz_wap/utils/mmversion.js"),l=(e("biz_wap/utils/ajax.js"),
e("appmsg/popup_report.js")),m=e("biz_wap/utils/jsmonitor_report.js"),_={
0:"文章",
11:"文章",
8:"图片",
7:"语音",
...
if("undefined"!=typeof jumpInfo)for(var d=0;d<jumpInfo.length;d++)c[jumpInfo[d].url]={
...
e.stopPropagation(),e.preventDefault(),"OTHER"===f._type&&m.setSum(110809,10,1),
l.report([4,l.getRedirectType(f._url),"",img_popup?1:0,window.source,l.getUrlData(f._url)]),
...
"OTHER"===f._type&&m.setSum(110809,9,1),f.style.display="none",l.report([3,l.getRedirectType(f._url),"",img_popup?1:0,window.source,l.getUrlData(f._url)]);
}),r;
...
t.share_redirect_url&&h&&(window._share_redirect_url=t.share_redirect_url,h.innerHTML=v.tmpl(u,{
...
})),t.comment_enabled&&b&&(b.style.display="block"),S.isIOS&&"block"===b.style.display&&location.href.match(/fontScale=\d+/)&&I.os.ipad&&I.os.getNumVersion()>=13){
var k=location.href.match(/fontScale=(\d+)/);
z(b,parseFloat(k[1])/100);
}
}
function o(){
...
e("biz_common/dom/event.js")),f=(e("biz_wap/utils/ajax.js"),e("biz_wap/jsapi/core.js")),v=e("biz_common/tmpl.js"),b=(e("complain/localstorage.js"),
